...
export default function Rewards() {
  ...
  const rewardTiers: RewardTier[] = [
    ...
    },
    {
      ...
      rewards: ["Premium AI search (unlimited)", "1-on-1 quant calls (monthly)", "Friend leaderboards"],
      unlocked: false,
      progress: 80,
    },
    {
      ...
      rewards: ["Early access to new features", "AI portfolio optimization", "Priority support"],
      unlocked: false,
      progress: 60,
    },
    {
      ...
      rewards: ["AI market insights", "Advanced charting tools", "1-on-1 quant calls (weekly)"],
      unlocked: false,
      progress: 40,
    },
    {
    ...
    },
    {
      ...
      rewards: ["Debit card with cashback", "1-on-1 quant calls (unlimited)", "Exclusive events"],
      unlocked: false,
      progress: 10,
    },
  ];
