...
export default function Rewards() {
  ...
  const rewardTiers: RewardTier[] = [
    ...
    },
    {
      ...
      requirements: ["Complete 10 stock analyses", "Use AI chat 5 times"],
      rewards: ["Advanced portfolio insights", "Priority support", "Weekly market reports"],
      unlocked: false,
      progress: 60,
    },
    {
      ...
      requirements: ["Build 3 investment queues", "30-day active streak"],
      rewards: ["Custom research reports", "Risk optimization tools", "API access"],
      unlocked: false,
      progress: 40,
    },
    {
    ...
    },
    {
      ...
      requirements: ["Analyze 50+ articles", "Maintain 90-day streak"],
      rewards: ["Institutional-grade tools", "Direct analyst access", "Beta features"],
      unlocked: false,
      progress: 10,
    },
  ];
