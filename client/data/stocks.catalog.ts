...
export const STOCKS: Record<string, Stock> = {
  ...
  MU: {id:"stk_mu",symbol:"MU",name:"Micron Technology, Inc.",exchange:"NASDAQ",sector:"Technology",price:85.42,change:2.15,changePercent:2.58,volume:"18.7M",marketCap:"94.8B",pe:15.2,dividendYield:0.0,isGainer:true,newsSummary:"Memory chip demand recovering, AI and data center growth driving sales",returns:{oneMonth:12.3,sixMonth:24.1,oneYear:67.8},earningsDate:"Jan 18, 2025",beta:1.8,eps:5.62,bookValue:28.43,priceToBook:3.0,revenue:"24.9B",netIncome:"7.8B",employees:48000,founded:"1978"},

  COIN: {id:"stk_coin",symbol:"COIN",name:"Coinbase Global, Inc.",exchange:"NASDAQ",sector:"Financial Services",price:165.78,change:4.23,changePercent:2.62,volume:"12.3M",marketCap:"41.2B",pe:null,dividendYield:0.0,isGainer:true,newsSummary:"Crypto trading volume surge, institutional adoption growing",returns:{oneMonth:8.7,sixMonth:45.2,oneYear:89.3},earningsDate:"Feb 15, 2025",beta:2.3,eps:-1.25,bookValue:34.12,priceToBook:4.9,revenue:"5.2B",netIncome:"-541M",employees:4948,founded:"2012"}
};
