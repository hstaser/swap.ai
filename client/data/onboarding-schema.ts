        ...
        options: [
          {
            ...
            description: "Quick gains and active trading",
          },
          {
            value: "medium",
            label: "Medium-term (1-5 years)",
            description: "Building wealth gradually",
          },
          {
            value: "long",
            label: "Long-term (5+ years)",
            description: "Retirement and major life goals",
          },
        ],
    ...
    questions: [
      {
        ...
        description:
          "Higher risk can mean higher returns, but also higher potential losses",
        required: true,
        ...
        options: [
          {
            ...
            description: "Very low risk tolerance",
          },
          {
            value: "worry-hold",
            label: "Worry but hold your positions",
            description: "Low risk tolerance",
          },
          {
            value: "stay-calm",
            label: "Stay calm and wait it out",
      ...
      },
      {
        ...
        options: [
          {
            value: "hate",
            label: "I hate seeing red numbers",
            description: "Prefer stable investments",
          },
          {
            value: "nervous",
            label: "Makes me nervous but I can handle it",
            description: "Some volatility OK",
          },
          {
            value: "neutral",
            label: "Part of investing, doesn't bother me",
            description: "Comfortable with normal volatility",
          },
          {
            value: "exciting",
            label: "I find it exciting and motivating",
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          {
            value: "major-moves",
            label: "Major market movements (+/- 5%)",
            icon: "TrendingUp",
          },
          {
            value: "earnings",
          ...
          {
            value: "news",
            label: "Breaking news affecting your stocks",
            icon: "Newspaper",
          },
          {
            value: "opportunities",
          ...
          },
          {
            ...
            label: "Portfolio rebalancing suggestions",
            icon: "BarChart",
          },
          {
      ...
      },
      {
        ...
        options: [
          {
            value: "summary",
            label: "Quick summaries only",
            description: "Key points in 2-3 sentences",
          },
          {
            value: "balanced",
            label: "Balanced overview",
            description: "Important details with context",
          },
          {
            value: "detailed",
            label: "Comprehensive analysis",
            description: "Full breakdown with data and charts",
          },
          {
            value: "custom",
            label: "Let me choose each time",
            description: "Flexible based on situation",
          },
        ],
        meta: { category: "ai", priority: "medium", version: "1.0" },
      },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "single-select",
        title:
          "Help improve our recommendations by sharing anonymous usage data?",
        required: true,
        options: [
          {
            value: "yes",
            label: "Yes, help improve the platform",
